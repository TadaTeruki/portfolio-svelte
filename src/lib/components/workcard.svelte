...
<a
    class="flex bg-transparent border-b border-gray-200 p-0 hover:bg-gray-100 transition-colors duration-300 ease-in-out dark:border-gray-700 dark:hover:bg-gray-700 h-20 overflow-hidden"
    target="_blank"
...
>
    <img
        ...
        alt={work.name}
        class="w-40 h-full object-cover rounded-sm shadow-sm dark:shadow-gray-700"
    />
